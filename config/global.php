...
define("HTTP_BASE","http://127.0.0.1/cocina");
define('ROOT_DIR',RUTA_BASE.'cocina');
define('ROOT_CORE',RUTA_BASE.'cocina/core');
define('ROOT_UPLOAD',RUTA_BASE.'cocina/uploads');
define('ROOT_VIEW',RUTA_BASE.'cocina/view');
define('ROOT_REPORT',RUTA_BASE.'cocina/reports');
define('ROOT_REPORT_DOWN',RUTA_BASE.'cocina/reports_download');
